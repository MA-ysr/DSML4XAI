 ...
 * @generated
 */
public class XaiConfigSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case XaiConfigPackage.EXPERTISE_LEVEL: {
				ExpertiseLevel expertiseLevel = (ExpertiseLevel)theEObject;
				T result = caseExpertiseLevel(expertiseLevel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XaiConfigPackage.DETAILS_LEVEL: {
				DetailsLevel detailsLevel = (DetailsLevel)theEObject;
				T result = caseDetailsLevel(detailsLevel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case XaiConfigPackage.DEBUG_TECHNIQUE: {
				DebugTechnique debugTechnique = (DebugTechnique)theEObject;
				T result = caseDebugTechnique(debugTechnique);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case XaiConfigPackage.TRAINING_POLICY: {
				TrainingPolicy trainingPolicy = (TrainingPolicy)theEObject;
				T result = caseTrainingPolicy(trainingPolicy);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case XaiConfigPackage.EXPLANATION_METHOD: {
				ExplanationMethod explanationMethod = (ExplanationMethod)theEObject;
				T result = caseExplanationMethod(explanationMethod);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Expertise Level</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Expertise Level</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseExpertiseLevel(ExpertiseLevel object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Details Level</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Details Level</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDetailsLevel(DetailsLevel object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Debug Technique</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Debug Technique</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDebugTechnique(DebugTechnique object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Training Policy</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Training Policy</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTrainingPolicy(TrainingPolicy object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Explanation Method</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Explanation Method</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseExplanationMethod(ExplanationMethod object) {
		return null;
	}

 ...
 * </p>
 * <ul>
 *   <li>{@link com.example.xai.model.xaiConfig.impl.PurposeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PurposeImpl extends MinimalEObjectImpl.Container implements Purpose {
	...
	protected EClass eStaticClass() {
		return XaiConfigPackage.Literals.PURPOSE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XaiConfigPackage.PURPOSE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XaiConfigPackage.PURPOSE__NAME:
				return getName();
		}

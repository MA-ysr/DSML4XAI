...
/**
 * This is the item provider adapter for a {@link com.example.xai.model.explainableAI.Model} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						explainableAIPackage.Literals.MODEL__NAME, true, false, false,
	...
	protected void addModelTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Model_modelType_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Model_modelType_feature",
								"_UI_Model_type"),
						explainableAIPackage.Literals.MODEL__MODEL_TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addMethodPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Model_method_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Model_method_feature", "_UI_Model_type"),
						explainableAIPackage.Literals.MODEL__METHOD, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(explainableAIPackage.Literals.MODEL__USER);
			childrenFeatures.add(explainableAIPackage.Literals.MODEL__DATASET);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(explainableAIPackage.Literals.MODEL__USER,
				explainableAIFactory.eINSTANCE.createUser()));

		newChildDescriptors.add(createChildParameter(explainableAIPackage.Literals.MODEL__DATASET,
				explainableAIFactory.eINSTANCE.createDataset()));
	}

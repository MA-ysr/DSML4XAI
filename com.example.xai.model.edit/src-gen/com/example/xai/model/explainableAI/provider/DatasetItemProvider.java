...
/**
 * This is the item provider adapter for a {@link com.example.xai.model.explainableAI.Dataset} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DatasetItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Dataset_path_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Dataset_path_feature", "_UI_Dataset_type"),
						explainableAIPackage.Literals.DATASET__PATH, true, false, false,
	...
	protected void addFormatPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Dataset_format_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Dataset_format_feature",
								"_UI_Dataset_type"),
						explainableAIPackage.Literals.DATASET__FORMAT, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addTargetColumnPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Dataset_targetColumn_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Dataset_targetColumn_feature",
								"_UI_Dataset_type"),
						explainableAIPackage.Literals.DATASET__TARGET_COLUMN, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((Dataset) object).getPath();
